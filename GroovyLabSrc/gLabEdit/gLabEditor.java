...
final  JMenuItem IdentifierVsPackageCompletionJMenuItem = new JMenuItem("Toggle  Identifier vs Package  completion mode, Identifier completion is now : " + (GlobalValues.performPackageCompletion == false) );
 ...
 completionMenu.add(jlapackCompletionJMenuItem);
   ...
   // switchLibrariesMenu.add(switchJBLASMenuItem);
    ...
    JMenuItem biojavaImportJMenuItem = new JMenuItem("BioJava toolbox Imports");
    biojavaImportJMenuItem.setFont(GlobalValues.uifont);
    biojavaImportJMenuItem.setToolTipText("directly the statements for the GroovySci based routines");
    biojavaImportJMenuItem.addActionListener(new ActionListener() {

                    public void actionPerformed(ActionEvent e) {
                 gLabEdit.importsHelper.injectBioJavaDirectly();
                    }
                });
    ...
    importsMenu.add(biojavaImportJMenuItem);
