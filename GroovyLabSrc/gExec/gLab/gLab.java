  ...
  if (explorerPanel != null)   {
        ...
        private void InitConsole()
        {
               ...
               SwingUtilities.invokeLater(() -> {
                   ...
                   WaveletToolbar waveletToolbar1 = new WaveletToolbar();
                   waveletToolbar1.setToolTipText("Wavelet Analysis Toolbar. At initial state of development yet!!");
                   OptimizationToolbar optimizationToolbar1 = new OptimizationToolbar();
                   optimizationToolbar1.setToolTipText("Wizards for performing numerical optimization tasks.  At initial state of development yet!!");
                   ODEToolbar odeToolbar1 = new ODEToolbar();
                   odeToolbar1.setToolTipText("Wizards for performing ODE numerical solving tasks.  At initial state of development yet!!");
                   ...
                   CalculusToolbar calculusToolbar1 = new  CalculusToolbar();
                   calculusToolbar1.setToolTipText(" Wizards for performing Calculus.  At initial state of development yet!!");
                   ...
                   tabbedToolbars.addTab("Optimization", optimizationToolbar1);
                   tabbedToolbars.setToolTipTextAt(toolBarCnt++, "Numerical Optimization of functions");
                   tabbedToolbars.addTab("ODE", odeToolbar1);
        ...
        private void InitJMenuBar(final ActionListener listener)
        {
            ...
            JMenuItem searchJarContentsForImportJMenuItem = new JMenuItem("Search jar file for injecting the proper import statements");
            searchJarContentsForImportJMenuItem.setFont(GlobalValues.uifont);
            searchJarContentsForImportJMenuItem.setToolTipText("Searches the jar file for classes matching the specified keyword, which then automatically imports");
            searchJarContentsForImportJMenuItem.addActionListener((ActionEvent e) -> {
                ...
                if (retVal == JFileChooser.APPROVE_OPTION) {
                    ...
                    String classToScan = JOptionPane.showInputDialog(null, "Input the keyword to scan for matched classes", "Keyword for importing matching classes", JOptionPane.INFORMATION_MESSAGE);

                    String proposedImports="";
                    try {
                        proposedImports = gExec.ClassLoaders.JarClassLoader.scanClass(jarFileToDisplay, classToScan);
                        gExec.Interpreter.GlobalValues.globalEditorPane.setText(proposedImports+gExec.Interpreter.GlobalValues.globalEditorPane.getText());
            ...
            searchClassPathForImportJMenuItem.addActionListener((ActionEvent e) -> {
                ...
                for (URL jarFileToSearchURL: GlobalValues.GroovyShell.getClassLoader().getURLs()) {
                     if (jarFileToSearchURL.getFile().isEmpty()==false) {
                      try {
                         String jarFileToSearch = jarFileToSearchURL.getPath();
                         
                        String proposedImports = gExec.ClassLoaders.JarClassLoader.scanClass(jarFileToSearch, classToScan);
                        gExec.Interpreter.GlobalValues.globalEditorPane.setText(proposedImports+gExec.Interpreter.GlobalValues.globalEditorPane.getText());
        ...
        if (retVal == JFileChooser.APPROVE_OPTION) { 
            ...
            Vector toolboxClasses    =  gExec.ClassLoaders.JarClassLoader.scanAll(jarFileToDisplay);
            gExec.gui.WatchClasses  watchClassesOfToolbox = new gExec.gui.WatchClasses();
            
        
            watchClassesOfToolbox.displayClasses( toolboxClasses,  jarFileToDisplay, gExec.gui.WatchClasses.watchXLoc+50, gExec.gui.WatchClasses.watchYLoc+50);
     
        }
                }
                );
                
                librariesMenu.add(displayJarContentsMenuItem);
                
                librariesMenu.add(searchJarContentsForImportJMenuItem);
                librariesMenu.add(searchClassPathForImportJMenuItem);
               ...
               mtjMenuItem.addActionListener((ActionEvent e) -> {
                ...
                GroovySciRoutinesMenuItemWithKeyword.addActionListener((ActionEvent e) -> {
                    gExec.gui.WatchClasses  watchClassesOfGroovySci = new gExec.gui.WatchClasses();
        ...
        appearanceMenu.setToolTipText("Appearance related settings (e.g. fonts, etc. )");
               ...
               increaseRSyntaxFontMenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_MINUS,  java.awt.event.InputEvent.ALT_DOWN_MASK));
               ...
               decreaseRSyntaxFontMenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_MINUS,  java.awt.event.InputEvent.CTRL_DOWN_MASK));
...
//GroovySciExamplesHelpJMenuItem.setIcon(new ImageIcon(groovyImage));
        ...
        examplesMenu.add(GroovySciWaveletExamplesHelpJMenuItem);
             ...
             GroovyHelpJMenuItem.addActionListener((ActionEvent e) -> {
                ...
                aboutHelpJMenuItem.addActionListener((java.awt.event.ActionEvent evt) -> {
