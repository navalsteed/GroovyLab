...
public class Evaluator {
    ...
    private void initializeEvaluator(EvaluationContext evaluationContext) {
        ...
        try {
                   classLoader.addURL(new URL("file", "localhost", gLabGlobals.JavaGlobals.ARPACKFile));
                   classLoader.addURL(new URL("file", "localhost", gLabGlobals.JavaGlobals.groovyJarFile));
                   classLoader.addURL(new URL("file", "localhost", gLabGlobals.JavaGlobals.ejmlFile));
                   classLoader.addURL(new URL("file", "localhost", gLabGlobals.JavaGlobals.jblasFile));
                   classLoader.addURL(new URL("file", "localhost", gLabGlobals.JavaGlobals.jsciFile));
                   classLoader.addURL(new URL("file", "localhost", gLabGlobals.JavaGlobals.mtjColtSGTFile));
                   classLoader.addURL(new URL("file", "localhost", gLabGlobals.JavaGlobals.ApacheCommonsFile));
                   classLoader.addURL(new URL("file", "localhost", gLabGlobals.JavaGlobals.numalFile));
                   classLoader.addURL(new URL("file", "localhost", gLabGlobals.JavaGlobals.LAPACKFile));
