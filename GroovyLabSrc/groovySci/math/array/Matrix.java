...
final public double [][] toDoubleArray() { 
    int Nrows = d.length; int Ncols = d[0].length;
    double [][] data = new double[Nrows][Ncols];
   System.arraycopy(d, 0, data, 0, Nrows);
 ...
 the routine also is used to cascade calls, using the extractedMatrixObject static variable, e.g. for 
   ...
   getAt() is called two times:
      ...
      *   the second time the receiver of the getAt() call becomes the extractedMatrix object
           and a column select of columns 1 to 3 is performed
*/
...
public static EigResults ceigen(Matrix a) {
 ...
 // implement some transforms using Parallel Colt library
...
public void insertRows( int l, double []...y) {
    d = DoubleArray.insertRows(d, l, y);
}

public void deleteColumns(int... J) {
   d =  DoubleArray.deleteColumns(d, J);
}

public void deleteRowsRange(int l1, int l2) {
   d = DoubleArray.deleteRowsRange(d, l1, l2);
}
